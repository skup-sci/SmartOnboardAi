...
export const AppProvider: React.FC<AppProviderProps> = ({ children }) => {
  ...
  // Create refs to services to ensure they're persisted across renders
  ...
  // Use the refs to access the services
  const userService = userServiceRef.current;
  const analyticsService = analyticsServiceRef.current;
  ...
  useEffect(() => {
    return () => {
      // Clean up GeminiService listeners
      if (geminiService && typeof geminiService.cleanup === 'function') {
